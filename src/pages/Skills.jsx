...
const SKILLS = [
  ...
  { name: "Pandas", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/pandas/pandas-original-wordmark.svg" },
...
const ROWS = [
  [
    { title: "GenAI & RAG", items: ["Retrieval-Augmented Generation (RAG)", "Vector Databases", "Semantic Search", "FAISS", "LangChain", "Prompt Engineering", "Google Gemini", "OpenAI GPT (API integration)"] },
    { title: "Deep Learning", items: ["PyTorch", "TensorFlow", "scikit-learn", "Hugging Face Transformers", "BERT (fine-tuning)", "Transfer Learning"] },
  ],
  [
    { title: "Data & ML", items: ["Python", "NumPy", "pandas", "matplotlib", "SQL", "Regression", "Classification", "Decision Trees", "Random Forest", "Feature Engineering", "Model Tuning"] },
    { title: "Languages & Frontend", items: ["JavaScript", "React.js"] },
    { title: "Backend / APIs", items: ["FastAPI", "Flask", "REST APIs", "Pydantic", "Node.js", "Express.js"] },
  ],
  [
    { title: "Tools & Deploy", items: ["Git", "GitHub", "Hugging Face Spaces", "Docker (basics)", "MongoDB", "SQLite"] },
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ✨ Technical expertise spanning AI/ML, Generative AI, and full-stack development — explore my core competencies below.
        </p>
      </motion.div>
